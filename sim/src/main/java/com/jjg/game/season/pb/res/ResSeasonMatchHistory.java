...
import com.jjg.game.season.pb.struct.SeasonMatchRecordInfo;

import java.util.List;

@ProtobufMessage(messageType = MessageConst.MessageTypeDef.SEASON, cmd = SeasonConstant.MsgBean.RES_SEASON_MATCH_HISTORY, resp = true)
@ProtoDesc("赛季对局记录返回")
