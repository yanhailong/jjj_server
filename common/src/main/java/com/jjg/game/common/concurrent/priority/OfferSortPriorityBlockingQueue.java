 ...
 * traverse the elements of the OfferSortPriorityBlockingQueue in any particular order. If you need
...
public class OfferSortPriorityBlockingQueue<E> extends AbstractQueue<E>
    ...
    /**
     * Creates a {@code OfferSortPriorityBlockingQueue} with the default initial capacity (11) that
     * orders its elements according to their {@linkplain Comparable natural ordering}.
     */
    public OfferSortPriorityBlockingQueue() {
        this(DEFAULT_INITIAL_CAPACITY, null);
    }

    /**
     * Creates a {@code OfferSortPriorityBlockingQueue} with the specified initial capacity that
     * orders its elements according to their {@linkplain Comparable natural ordering}.
     *
     * @param initialCapacity the initial capacity for this priority queue
     * @throws IllegalArgumentException if {@code initialCapacity} is less than 1
     */
    public OfferSortPriorityBlockingQueue(int initialCapacity) {
     ...
     * @throws IllegalArgumentException if {@code initialCapacity} is less than 1
     */
    public OfferSortPriorityBlockingQueue(int initialCapacity, Comparator<? super E> comparator) {
    ...
    /**
     * Creates a {@code OfferSortPriorityBlockingQueue} containing the elements in the specified
     ...
     */
    public OfferSortPriorityBlockingQueue(Collection<? extends E> c) {
        ...
        if (c instanceof SortedSet<?>) {
            ...
            heapify = false;
        } else if (c instanceof OfferSortPriorityBlockingQueue<?>) {
            OfferSortPriorityBlockingQueue<? extends E> pq =
                (OfferSortPriorityBlockingQueue<? extends E>) c;
            this.comparator = (Comparator<? super E>) pq.comparator();
            screen = false;
            if (pq.getClass() == OfferSortPriorityBlockingQueue.class) // exact match
                heapify = false;
        }
        Object[] es = c.toArray();
        int n = es.length;
    ...
    public boolean offer(E e) {
        ...
        try {
            ...
            size = n + 1;
            PlayerPriority playerPriority = ((BasePriorityHandlerRunnable) e).getPlayerPriority();
    ...
    /**
     * Always returns {@code Integer.MAX_VALUE} because a {@code OfferSortPriorityBlockingQueue} is
    ...
    static {
        try {
            ...
            ALLOCATIONSPINLOCK =
                l.findVarHandle(OfferSortPriorityBlockingQueue.class, "allocationSpinLock", int.class);
