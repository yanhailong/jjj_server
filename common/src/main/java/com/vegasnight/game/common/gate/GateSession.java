...
import com.vegasnight.game.common.message.SessionCreate;
import com.vegasnight.game.common.message.SessionLogout;
import com.vegasnight.game.common.message.SessionQuit;
import com.vegasnight.game.common.net.Connect;
import com.vegasnight.game.common.net.ConnectListener;
import com.vegasnight.game.common.net.Inbox;
import com.vegasnight.game.common.net.NetAddress;
import com.vegasnight.game.common.netty.NettyConnect;
import com.vegasnight.game.common.pb.*;
...
public class GateSession extends NettyConnect<PFMessage> implements Inbox<PFMessage>, ConnectListener {
    ...
    public void messageReceived(PFMessage msg) {
        ...
        try {
            Connect micconnect = ClusterSystem.system.micserviceAllot(currentClient, msg.messageType);
            if (micconnect != null) {
