...
import com.jjg.game.ploy.manager.PloyPlayerEventListener;
...
public class PloyRoomMessageHandler {
    private final Logger log = LoggerFactory.getLogger(getClass());

    @Autowired
    private ClusterSystem clusterSystem;
    @Autowired
    private PloyPlayerEventListener ployPlayerEventListener;
    ...
    public void reqExitGame(PlayerController playerController, ReqExitGame req) {
        try {
            ...
            int code = ployPlayerEventListener.exitGame(playerController.getSession(), ExitType.INITIATIVE);
