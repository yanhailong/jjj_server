...
@ProtobufMessage(messageType = MessageConst.MessageTypeDef.TO_SOUTH_BLOOD, cmd = ToSouthBloodConstant.MsgBean.NOTIFY_BOMB_SETTLEMENT, resp = true)
@ProtoDesc("南方前进-血战炸弹结算通知")
