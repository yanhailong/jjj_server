...
public class ToSouthBloodPlayCardPhase extends BasePlayCardPhase<ToSouthBloodGameDataVo> {
    private static final Logger log = LoggerFactory.getLogger(ToSouthBloodPlayCardPhase.class);

    public ToSouthBloodPlayCardPhase(AbstractPhaseGameController<Room_ChessCfg, ToSouthBloodGameDataVo> gameController) {
