 ...
 *     <li>单局模拟委托给 {@link ToSouthFreeCardLibGenerator}</li>
 *     <li>玩家连胜/盈亏的委托方法</li>
 * </ul>
 */
@Component
public class ToSouthFreeCardLibManager
    ...
    @Override
    protected ToSouthFreeCardLibDao getCardLibDao() {
        return cardLibDao;
    }
    ...
    @Override
    protected List<ToSouthFreeCardLib> simulateOneGame() {
        if (cachedMoneyCfg == null) {
            return Collections.emptyList();
        }
        return ToSouthFreeCardLibGenerator.simulateOneGame(cachedPoolId, cachedMoneyCfg);
    }
