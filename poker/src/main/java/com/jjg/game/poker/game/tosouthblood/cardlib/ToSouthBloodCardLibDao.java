 ...
 * 本类只保留南方前进-血战特有的 Redis 操作（玩家连胜/盈亏）。
 */
@Component
public class ToSouthBloodCardLibDao extends AbstractCardLibDao<ToSouthBloodCardLib> {

    public ToSouthBloodCardLibDao() {
        super(ToSouthBloodCardLib.class, CoreConst.GameType.TO_SOUTH);
    }
