 ...
 * 南方前进好友房游戏控制器
 */
@GameController(gameType = EGameType.TO_SOUTH, roomType = RoomType.POKER_TEAM_UP_ROOM)
public class ToSouthFriendGameController extends ToSouthGameController {

    public ToSouthFriendGameController(AbstractRoomController<Room_ChessCfg, ? extends Room> roomController) {
