...
public class ToSouthFreeActionInfo {
    ...
    public List<ToSouthFreeRecommendCards> recommendCardsList;
    @ProtoDesc("在本轮中玩家基本信息")
    public List<ToSouthFreeCurRoundPlayerInfo> curRoundPlayerInfos = new ArrayList<>();
    @ProtoDesc("在本轮中已打出的牌历史记录")
    public List<ToSouthFreePlayCardRecord> curRoundPlayedCardHistory = new ArrayList<>();
