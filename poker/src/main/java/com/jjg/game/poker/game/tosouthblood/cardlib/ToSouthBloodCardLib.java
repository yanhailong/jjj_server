 ...
 * 抽中后发给触发权重修改的真人玩家
 */
public class ToSouthBloodCardLib implements CardLibEntry {
    ...
    public ToSouthBloodCardLib() {
    }

    public ToSouthBloodCardLib(long multiplier, List<Integer> playerCards, List<List<Integer>> robotCards) {
