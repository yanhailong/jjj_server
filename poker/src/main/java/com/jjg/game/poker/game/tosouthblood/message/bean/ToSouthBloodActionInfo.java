...
public class ToSouthBloodActionInfo {
    ...
    public List<ToSouthBloodRecommendCards> recommendCardsList;
    @ProtoDesc("在本轮中玩家基本信息")
    public List<ToSouthBloodCurRoundPlayerInfo> curRoundPlayerInfos = new ArrayList<>();
    @ProtoDesc("在本轮中已打出的牌历史记录")
    public List<ToSouthBloodPlayCardRecord> curRoundPlayedCardHistory = new ArrayList<>();
