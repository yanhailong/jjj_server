package com.jjg.game.poker.game.tosouthblood.constant;

import com.jjg.game.common.constant.MessageConst;

public class ToSouthBloodConstant {

    public interface MsgBean {
        int BASE_MSG_PREFIX = MessageConst.MessageTypeDef.TO_SOUTH_BLOOD << MessageConst.MessageCommon.RIGHT_MOVE;
