package com.jjg.game.poker.game.tosouthfree.constant;

import com.jjg.game.common.constant.MessageConst;

public class ToSouthFreeConstant {

    public interface MsgBean {
        int BASE_MSG_PREFIX = MessageConst.MessageTypeDef.TO_SOUTH_FREE << MessageConst.MessageCommon.RIGHT_MOVE;
