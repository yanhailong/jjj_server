...
public class ToSouthFreeGameDataVo extends BasePokerGameDataVo {
    ...
    // 当前回合出牌记录 (用于炸弹结算)
    private final List<ToSouthFreeRoundRecord> currentRoundPlays = new ArrayList<>();
    ...
    private ToSouthFreeGameLog gameLog = new ToSouthFreeGameLog();
    ...
    public ToSouthFreeGameDataVo(Room_ChessCfg roomCfg) {
        super(roomCfg);
    }
    ...
    public List<ToSouthFreeRoundRecord> getCurrentRoundPlays() {
    ...
    public ToSouthFreeSettlementContext getInstantWinContext() {
        return instantWinContext;
    }

    public void setInstantWinContext(ToSouthFreeSettlementContext instantWinContext) {
    ...
    public ToSouthFreeGameLog getGameLog() {
        return gameLog;
    }

    @Override
    public int getPoolId() {
        return ToSouthFreeDataHelper.getPoolId(this);
    }
    ...
    public void resetData(BasePokerGameController<? extends BasePokerGameDataVo> controller) {
        ...
        this.gameLog = new ToSouthFreeGameLog();
    }
}
