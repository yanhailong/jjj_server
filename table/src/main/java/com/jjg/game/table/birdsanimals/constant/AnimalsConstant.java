package com.jjg.game.table.birdsanimals.constant;
 ...
 * @author 2CL
 */
public interface AnimalsConstant {

    int BASE_MSG_PREFIX = BIRDS_ANIMAL_TYPE << MessageConst.MessageCommon.RIGHT_MOVE;
