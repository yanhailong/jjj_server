...
@ProtobufMessage(
    ...
    cmd = RussianLetteMessageConstant.ReqMsgBean.REQ_RUSSIAN_LETTE_OTHER_SUMMARY_LIST
)
@ProtoDesc("请求获取俄罗斯转盘其他房间摘要信息")
public class ReqRussianLetteOtherSummaryList extends AbstractMessage {
}
