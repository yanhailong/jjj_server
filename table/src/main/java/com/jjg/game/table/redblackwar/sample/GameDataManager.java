package com.jjg.game.table.redblackwar.sample;
...
// =================== 模板开始 ===================
import com.jjg.game.table.redblackwar.sample.bean.*;
import com.jjg.game.table.redblackwar.sample.container.*;
// =================== 模板结束 ===================
import com.jjg.game.table.redblackwar.sample.container.BaseCfgContainer.ContainerExceptionBlocker;
...
public class GameDataManager {
  ...
  public static void main(String[] args) throws Exception {
    loadAllData("E:\\java\\project2\\table\\resources\\sample\\redblackwar");
  }
}
