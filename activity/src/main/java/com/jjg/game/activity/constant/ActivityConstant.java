...
public interface ActivityConstant {
    ...
    interface MsgBean {
        ...
        //大转盘
        int RES_GRAND_ROULETTE_JOIN_ACTIVITY = BASE_MSG_PREFIX | 0x81;
        int RES_GRAND_ROULETTE_CLAIM_REWARDS = BASE_MSG_PREFIX | 0x82;
        int RES_GRAND_ROULETTE_TYPE_INFO = BASE_MSG_PREFIX | 0x83;

        int REQ_GRAND_ROULETTE_HISTORY = BASE_MSG_PREFIX | 0x84;
        int RES_GRAND_ROULETTE_HISTORY = BASE_MSG_PREFIX | 0x85;
