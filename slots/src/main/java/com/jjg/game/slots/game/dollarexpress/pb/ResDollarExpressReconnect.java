...
/**
 * @author 11
 * @date 2025/8/26 14:46
 */
@ProtobufMessage(messageType = MessageConst.MessageTypeDef.DOLLAR_EXPRESS_TYPE, cmd = DollarExpressConstant.MsgBean.RES_DOLLAR_EXPRESS_RECONNECT,resp = true)
@ProtoDesc("请求重连信息")
public class ResDollarExpressReconnect extends AbstractResponse {
    @ProtoDesc("图标id列表")
    ...
    public ResDollarExpressReconnect(int code) {
        super(code);
    }
}
