 ...
 */
@ProtobufMessage(messageType = MessageConst.MessageTypeDef.PAN_JIN_LIAN, cmd = PanJinLianConstant.MsgBean.RES_START_GAME,resp = true)
@ProtoDesc("开始游戏结果返回")
public class ResPanJinLianStartGame extends AbstractResponse {
    @ProtoDesc("图标id列表")
    ...
    public long exp;
    @ProtoDesc("中奖图标信息")
    public List<PanJinLianIconInfo> rewardIconInfo;

    public ResPanJinLianStartGame(int code) {
        super(code);
    }
}