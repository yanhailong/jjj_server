...
//import com.jjg.game.slots.game.dollarexpress.dao.DollarExpressResultDao;
...
//import com.jjg.game.slots.game.dollarexpress.sample.bean.DollarExpressIconCfg;
//import com.jjg.game.slots.game.dollarexpress.sample.bean.DollarExpressLineCfg;
//import com.jjg.game.slots.game.dollarexpress.sample.bean.DollarExpressShowCfg;
...
//        try{
//            int[] arr = new int[SlotsConst.Common.ALL_CION_COUNT];
//            int index = 0;
//
...
//                for(int j = 0; j< SlotsConst.Common.COLUM_ICON_COUNT; j++){
//                    int num = rand + j;
...
//
//        //如果是保险箱，就不检查中奖线
//        if(result.getSpecialType() != SlotsConst.Common.SPECIAL_TYPE_SAFE_BOX){
//            //中奖线
...
//
//        //检查第0-3轴
//        for(int i = SlotsConst.Common.COLUM_0_ID_BEGIN; i< SlotsConst.Common.COLUM_3_ID_END; i++){
//            int iconId = result.getIconArr()[i];
//
//            if(isTrainId(iconId)){ //检查火车
//                result.setSpecialType(SlotsConst.Common.SPECIAL_TYPE_TRAIN);
//            }else if(iconId == SlotsConst.Icon.DOLLAR_ID){  //检查美元图标
//                dollarIconCount++;
//            }else if(iconId == SlotsConst.Icon.ALL_ABOARD_ID){ //免费
//                freeIconCount++;
//            }
//        }
//
...
//            //检查第4轴
//            for(int i = SlotsConst.Common.COLUM_4_ID_BEGIN; i< SlotsConst.Common.COLUM_4_ID_END; i++){
//                int iconId = result.getIconArr()[i];
//                //是否有保险箱
//                if(iconId == SlotsConst.Icon.SAFE_BOX_ID){
//                    addDollar = true;
//                }
//
//                //是否有金火车
//                if(iconId == SlotsConst.Icon.GOLD_TRAIN_ID){
//                    result.setSpecialType(SlotsConst.Common.SPECIAL_TYPE_GOLD_TRAIN);
//                }
//            }
//
//            if(addDollar){
//                //dollar icon的配置
//                DollarExpressIconCfg dollarIconCfg = GameDataManager.getDollarExpressIconCfg(SlotsConst.Icon.DOLLAR_ID);
...
//        //大于3个才会触发免费游戏
//        if(freeIconCount >= 3){
//            result.setSpecialType(SlotsConst.Common.SPECIAL_TYPE_FREE);
//        }
//
//        return result;
//    }
...
//
//        boolean normal1 = iconId1 <= SlotsConst.Icon.NORMAL_TYPE_MAX_ID;
//        boolean normal2 = iconId2 <= SlotsConst.Icon.NORMAL_TYPE_MAX_ID;
//
//        if(iconId1 == iconId2){
...
//        return iconId == SlotsConst.Icon.RED_TRAIN_ID ||
//                iconId == SlotsConst.Icon.GREEN_TRAIN_ID ||
//                iconId == SlotsConst.Icon.BLUE_TRAIN_ID ||
//                iconId == SlotsConst.Icon.PURPLE_TRAIN_ID;
//    }
//
//    /**
...
//        if(iconId == SlotsConst.Icon.WILD_1_ID || iconId == SlotsConst.Icon.WILD_2_ID || iconId == SlotsConst.Icon.WILD_5_ID){
