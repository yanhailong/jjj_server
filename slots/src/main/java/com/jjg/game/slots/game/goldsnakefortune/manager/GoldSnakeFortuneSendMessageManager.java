...
@Component
public class GoldSnakeFortuneSendMessageManager extends BaseSendMessageManager {
    @Autowired
    private GoldSnakeFortuneGameManager gameManager;
    @Autowired
    private GoldSnakeFortuneGenerateManager generateManager;
    @Autowired
    ...
    public void sendConfigMessage(PlayerController playerController, GoldSnakeFortuneGameRunInfo gameRunInfo) {
        ...
        ResGoldSnakeFortuneEnterGame res = new ResGoldSnakeFortuneEnterGame(Code.SUCCESS);
        if (config != null) {
     ...
     * @param gameRunInfo
     */
    public void sendStartGameMessage(PlayerController playerController, GoldSnakeFortuneGameRunInfo gameRunInfo) {
        SendInfo sendInfo = new SendInfo();

        ResGoldSnakeFortuneStartGame res = new ResGoldSnakeFortuneStartGame(gameRunInfo.getCode());
     ...
     * @param gameRunInfo
     */
    public void sendPoolValue(PlayerController playerController, GoldSnakeFortuneGameRunInfo gameRunInfo) {
        SendInfo sendInfo = new SendInfo();
