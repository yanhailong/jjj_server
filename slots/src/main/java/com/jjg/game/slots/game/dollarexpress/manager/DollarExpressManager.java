...
//import com.jjg.game.slots.game.dollarexpress.dao.DollarExpressPoolDao;
...
//import com.jjg.game.slots.game.dollarexpress.sample.bean.DollarExpressControlCfg;
//import com.jjg.game.slots.game.dollarexpress.sample.bean.DollarExpressResultWeightCfg;
//import com.jjg.game.slots.game.dollarexpress.sample.bean.DollarExpressWareHouseCfg;
//import com.jjg.game.slots.game.dollarexpress.service.DollarExpressPlayerService;
...
//            }
//
//            end = addControlSpecialProp(begin,end,cfg.getTrain(),propMap, SlotsConst.Common.CONTROLL_SPECIAL_TRAIN_ID);
//
//            end = addControlSpecialProp(begin,end,cfg.getSafeBox(),propMap, SlotsConst.Common.CONTROLL_SPECIAL_SAFE_BOX_ID);
//
//            end = addControlSpecialProp(begin,end,cfg.getFree(),propMap, SlotsConst.Common.CONTROLL_SPECIAL_FREE_ID);
//
//            end = addControlSpecialProp(begin,end,cfg.getGoldTrain(),propMap, SlotsConst.Common.CONTROLL_SPECIAL_GOLD_TRAIN_ID);
//
