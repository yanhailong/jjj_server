 ...
 * @date 2025/8/1 17:48
 */
@ProtobufMessage(messageType = MessageConst.MessageTypeDef.ANGRY_BIRDS, cmd = AngryBirdsConstant.MsgBean.RES_ANGRY_BIRDS_ENTER_GAME, resp = true)
@ProtoDesc("返回配置信息")
public class ResAngryBirdsEnterGame extends AbstractResponse {
    @ProtoDesc("押注列表")
    ...
    @ProtoDesc("奖池信息")
    public List<AngryBirdsPoolInfo> poolList;
    @ProtoDesc("免费倍率")
    public int freeMultiplier;

    public ResAngryBirdsEnterGame(int code) {
        super(code);
    }
}
