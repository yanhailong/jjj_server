...
@Document
public class GaraGemstone2PlayerGameDataRoomDTO extends SlotsPlayerGameDataRoomDTO {
    //缓存免费的结果库
    ...
    public GaraGemstone2ResultLib getFreeLib() {
        return freeLib;
    }

    public void setFreeLib(GaraGemstone2ResultLib freeLib) {
    ...
    public <T extends SlotsPlayerGameData> T converToGameData(Class<T> cla) throws Exception {
        ...
        if (t instanceof GaraGemstone2PlayerGameData playerGameData) {
