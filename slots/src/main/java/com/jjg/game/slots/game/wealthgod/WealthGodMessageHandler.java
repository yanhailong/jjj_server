...
public class WealthGodMessageHandler {
    ...
    public WealthGodMessageHandler(WealthGodGameManager gameManager, WealthGodSendMessageManager sendMessageManager) {
    ...
    public void reqConfigInfo(PlayerController playerController, ReqWealthGodConfigInfo req) {
        try {
            ...
            WealthGodGameRunInfo gameRunInfo = gameManager.enterGame(playerController);
    ...
    public void reqPoolValue(PlayerController playerController, ReqWealthGodPoolValue req) {
        try {
            ...
            long poolValue = gameManager.getPoolValue(playerController);
