package com.jjg.game.slots.sample;
...
import com.jjg.game.slots.sample.container.*;
// =================== 模板结束 ===================
import com.jjg.game.slots.sample.container.BaseCfgContainer.ContainerExceptionBlocker;
...
public class GameDataManager {
  ...
  public static void main(String[] args) throws Exception {
    loadAllData("D:\\workspace\\gameserver\\slots\\resources\\sample");
  }
}
