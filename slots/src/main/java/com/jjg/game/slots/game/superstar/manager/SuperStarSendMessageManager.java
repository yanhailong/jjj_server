...
public class SuperStarSendMessageManager extends BaseSendMessageManager {
     ...
     * @param gameRunInfo
     */
    public void sendStartGameMessage(PlayerController playerController, SuperStarGameRunInfo gameRunInfo) {
        SendInfo sendInfo = new SendInfo();

        ResSuperStarStartGame res = new ResSuperStarStartGame(gameRunInfo.getCode());
