 ...
 */
@Component
public class ChristmasBashNightGameManager extends AbstractSlotsGameManager<ChristmasBashNightPlayerGameData, ChristmasBashNightResultLib> {
    @Autowired
    private ChristmasBashNightResultLibDao libDao;
    @Autowired
    ...
    @Autowired
    private ChristmasBashNightGameDataDao gameDataDao;
...
//        addGenerateLibEvent(map);
     ...
     * @return
     */
    private ChristmasBashNightGameRunInfo free(ChristmasBashNightGameRunInfo gameRunInfo, ChristmasBashNightPlayerGameData playerGameData) {
