 ...
 */
@Component
public class FrozenThroneGameManager extends AbstractSlotsGameManager<FrozenThronePlayerGameData, FrozenThroneResultLib> {
    @Autowired
...
//        addGenerateLibEvent(map);
     ...
     * @return
     */
    private FrozenThroneGameRunInfo normal(FrozenThroneGameRunInfo gameRunInfo, FrozenThronePlayerGameData playerGameData, long betValue) {
     ...
     * @return
     */
    private FrozenThroneGameRunInfo free(FrozenThroneGameRunInfo gameRunInfo, FrozenThronePlayerGameData playerGameData) {
