...
@Document
public class GaraGemstone1PlayerGameDataRoomDTO extends SlotsPlayerGameDataRoomDTO {
    //缓存免费的结果库
    private GaraGemstone1ResultLib freeLib;
    //剩余的免费次数
    private int remainFreeCount;
    //当前的免费游戏数组中的下标值
    private int freeIndex;

    public GaraGemstone1ResultLib getFreeLib() {
        return freeLib;
    }

    public void setFreeLib(GaraGemstone1ResultLib freeLib) {
    ...
    public <T extends SlotsPlayerGameData> T converToGameData(Class<T> cla) throws Exception {
        ...
        if (t instanceof GaraGemstone1PlayerGameData playerGameData) {
