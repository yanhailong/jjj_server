...
*/
@Document
public class HotFootballPlayerGameDataRoomDTO extends SlotsPlayerGameDataRoomDTO {
    //缓存免费的结果库
    ...
    public HotFootballResultLib getFreeLib() {
        return freeLib;
    }

    public void setFreeLib(HotFootballResultLib freeLib) {
    ...
    public <T extends SlotsPlayerGameData> T converToGameData(Class<T> cla) throws Exception {
        ...
        if (t instanceof HotFootballPlayerGameData playerGameData) {
