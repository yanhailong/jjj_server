package com.jjg.game.slots.game.dollarexpress.sample;
...
// =================== 模板开始 ===================
import com.jjg.game.slots.game.dollarexpress.sample.bean.*;
import com.jjg.game.slots.game.dollarexpress.sample.container.*;
// =================== 模板结束 ===================
import com.jjg.game.slots.game.dollarexpress.sample.container.BaseCfgContainer.ContainerExceptionBlocker;
...
public class GameDataManager {
  ...
  public Map<Class<? extends BaseCfgBean>, BaseCfgContainer<?>> initAllContainer() {
    ...
    // region===============cfg加载模板开始===================
    containerMap.put(DollarExpressControlCfg.class, new DollarExpressControlCfgContainer());
    containerMap.put(DollarExpressFreeWeightConfigCfg.class, new DollarExpressFreeWeightConfigCfgContainer());
    containerMap.put(DollarExpressGolbalConfigCfg.class, new DollarExpressGolbalConfigCfgContainer());
    containerMap.put(DollarExpressIconCfg.class, new DollarExpressIconCfgContainer());
    containerMap.put(DollarExpressLineCfg.class, new DollarExpressLineCfgContainer());
    containerMap.put(DollarExpressResultShowConfigCfg.class, new DollarExpressResultShowConfigCfgContainer());
    containerMap.put(DollarExpressResultWeightCfg.class, new DollarExpressResultWeightCfgContainer());
    containerMap.put(DollarExpressShowCfg.class, new DollarExpressShowCfgContainer());
    containerMap.put(DollarExpressWareHouseCfg.class, new DollarExpressWareHouseCfgContainer());
    containerMap.put(DollarExpressWeightIconConfigCfg.class, new DollarExpressWeightIconConfigCfgContainer());
    containerMap.put(DollarExpressWinShowConfigCfg.class, new DollarExpressWinShowConfigCfgContainer());
    // endregion===============cfg加载模板结束===================
    return containerMap;
  }
  ...
  public static DollarExpressControlCfg getDollarExpressControlCfg(int key) {
    return getInstance().getCfgContainer(DollarExpressControlCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, DollarExpressControlCfg> getDollarExpressControlCfgMap() {
    return getInstance().getCfgContainer(DollarExpressControlCfg.class).getCfgBeanMap();
  }

  public static List<DollarExpressControlCfg> getDollarExpressControlCfgList() {
    return getInstance().getCfgContainer(DollarExpressControlCfg.class).getCfgBeanList();
  }
  public static DollarExpressFreeWeightConfigCfg getDollarExpressFreeWeightConfigCfg(int key) {
    return getInstance().getCfgContainer(DollarExpressFreeWeightConfigCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, DollarExpressFreeWeightConfigCfg> getDollarExpressFreeWeightConfigCfgMap() {
    return getInstance().getCfgContainer(DollarExpressFreeWeightConfigCfg.class).getCfgBeanMap();
  }

  public static List<DollarExpressFreeWeightConfigCfg> getDollarExpressFreeWeightConfigCfgList() {
    return getInstance().getCfgContainer(DollarExpressFreeWeightConfigCfg.class).getCfgBeanList();
  }
  public static DollarExpressGolbalConfigCfg getDollarExpressGolbalConfigCfg(int key) {
    return getInstance().getCfgContainer(DollarExpressGolbalConfigCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, DollarExpressGolbalConfigCfg> getDollarExpressGolbalConfigCfgMap() {
    return getInstance().getCfgContainer(DollarExpressGolbalConfigCfg.class).getCfgBeanMap();
  }

  public static List<DollarExpressGolbalConfigCfg> getDollarExpressGolbalConfigCfgList() {
    return getInstance().getCfgContainer(DollarExpressGolbalConfigCfg.class).getCfgBeanList();
  }
  public static DollarExpressIconCfg getDollarExpressIconCfg(int key) {
    return getInstance().getCfgContainer(DollarExpressIconCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, DollarExpressIconCfg> getDollarExpressIconCfgMap() {
    return getInstance().getCfgContainer(DollarExpressIconCfg.class).getCfgBeanMap();
  }

  public static List<DollarExpressIconCfg> getDollarExpressIconCfgList() {
    return getInstance().getCfgContainer(DollarExpressIconCfg.class).getCfgBeanList();
  }
  public static DollarExpressLineCfg getDollarExpressLineCfg(int key) {
    return getInstance().getCfgContainer(DollarExpressLineCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, DollarExpressLineCfg> getDollarExpressLineCfgMap() {
    return getInstance().getCfgContainer(DollarExpressLineCfg.class).getCfgBeanMap();
  }

  public static List<DollarExpressLineCfg> getDollarExpressLineCfgList() {
    return getInstance().getCfgContainer(DollarExpressLineCfg.class).getCfgBeanList();
  }
  public static DollarExpressResultShowConfigCfg getDollarExpressResultShowConfigCfg(int key) {
    return getInstance().getCfgContainer(DollarExpressResultShowConfigCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, DollarExpressResultShowConfigCfg> getDollarExpressResultShowConfigCfgMap() {
    return getInstance().getCfgContainer(DollarExpressResultShowConfigCfg.class).getCfgBeanMap();
  }

  public static List<DollarExpressResultShowConfigCfg> getDollarExpressResultShowConfigCfgList() {
    return getInstance().getCfgContainer(DollarExpressResultShowConfigCfg.class).getCfgBeanList();
  }
  public static DollarExpressResultWeightCfg getDollarExpressResultWeightCfg(int key) {
    return getInstance().getCfgContainer(DollarExpressResultWeightCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, DollarExpressResultWeightCfg> getDollarExpressResultWeightCfgMap() {
    return getInstance().getCfgContainer(DollarExpressResultWeightCfg.class).getCfgBeanMap();
  }

  public static List<DollarExpressResultWeightCfg> getDollarExpressResultWeightCfgList() {
    return getInstance().getCfgContainer(DollarExpressResultWeightCfg.class).getCfgBeanList();
  }
  public static DollarExpressShowCfg getDollarExpressShowCfg(int key) {
    return getInstance().getCfgContainer(DollarExpressShowCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, DollarExpressShowCfg> getDollarExpressShowCfgMap() {
    return getInstance().getCfgContainer(DollarExpressShowCfg.class).getCfgBeanMap();
  }

  public static List<DollarExpressShowCfg> getDollarExpressShowCfgList() {
    return getInstance().getCfgContainer(DollarExpressShowCfg.class).getCfgBeanList();
  }
  public static DollarExpressWareHouseCfg getDollarExpressWareHouseCfg(int key) {
    return getInstance().getCfgContainer(DollarExpressWareHouseCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, DollarExpressWareHouseCfg> getDollarExpressWareHouseCfgMap() {
    return getInstance().getCfgContainer(DollarExpressWareHouseCfg.class).getCfgBeanMap();
  }

  public static List<DollarExpressWareHouseCfg> getDollarExpressWareHouseCfgList() {
    return getInstance().getCfgContainer(DollarExpressWareHouseCfg.class).getCfgBeanList();
  }
  public static DollarExpressWeightIconConfigCfg getDollarExpressWeightIconConfigCfg(int key) {
    return getInstance().getCfgContainer(DollarExpressWeightIconConfigCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, DollarExpressWeightIconConfigCfg> getDollarExpressWeightIconConfigCfgMap() {
    return getInstance().getCfgContainer(DollarExpressWeightIconConfigCfg.class).getCfgBeanMap();
  }

  public static List<DollarExpressWeightIconConfigCfg> getDollarExpressWeightIconConfigCfgList() {
    return getInstance().getCfgContainer(DollarExpressWeightIconConfigCfg.class).getCfgBeanList();
  }
  public static DollarExpressWinShowConfigCfg getDollarExpressWinShowConfigCfg(int key) {
    return getInstance().getCfgContainer(DollarExpressWinShowConfigCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, DollarExpressWinShowConfigCfg> getDollarExpressWinShowConfigCfgMap() {
    return getInstance().getCfgContainer(DollarExpressWinShowConfigCfg.class).getCfgBeanMap();
  }

  public static List<DollarExpressWinShowConfigCfg> getDollarExpressWinShowConfigCfgList() {
    return getInstance().getCfgContainer(DollarExpressWinShowConfigCfg.class).getCfgBeanList();
  }
  ...
  public static void main(String[] args) throws Exception {
    loadAllData("D:\\workspace\\gameserver\\slots\\resources\\sample\\dollarexpress");
  }
}
