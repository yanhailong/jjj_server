...
public abstract class AbstractDollarExpressGameManager extends AbstractSlotsGameManager<DollarExpressPlayerGameData, DollarExpressResultLib> {
     ...
     * @return
     */
    protected int chooseFreeGameType(DollarExpressPlayerGameData playerGameData, int chooseStatus) {
...
//        //计算火车奖励
     ...
     * @return
     */
    protected DollarExpressGameRunInfo allBoardFree(DollarExpressGameRunInfo gameRunInfo, DollarExpressPlayerGameData playerGameData) {
...
//            gameRunInfo.addBigPoolTimes(gameRunInfo.getDollarsGoldTimes());
     ...
     * @return
     */
    protected List<ResultLineInfo> transAwardLinePbInfo(List<DollarExpressAwardLineInfo> infoList, long oneBetScore) {
...
//            resultLineInfo.times = lineInfo.getBaseTimes();
     ...
     * @return
     */
    protected List<TrainInfo> transTrainPbInfo(SpecialAuxiliaryInfo specialAuxiliaryInfo, long bet) {
    ...
    protected TrainInfo goldTrainPbInfo(int goldTrainCount, long gold) {
     ...
     * @return
     */
    protected DollarExpressGameRunInfo calTrainReward(DollarExpressPlayerGameData playerGameData, DollarExpressResultLib lib, DollarExpressGameRunInfo gameRunInfo) {
        if (lib.getSpecialAuxiliaryInfoList() == null || lib.getSpecialAuxiliaryInfoList().isEmpty()) {
            return gameRunInfo;
        }
     ...
     * @param playerGameData
     */
    protected DollarExpressGameRunInfo checkInvers(DollarExpressPlayerGameData playerGameData, DollarExpressGameRunInfo gameRunInfo) {
     ...
     * @return
     */
    protected List<Integer> getChoosableAreas(DollarExpressPlayerGameData playerGameData) {
     ...
     * @return
     */
    protected int getPoolIdByTrain(int train) {
