 ...
 * @author lm
 * @date 2026/2/4
 * 注意：新增字段请同步到 Room DTO，避免房间模式丢字段。
 */
@Document
public class PanJinLianPlayerGameDataRoomDTO extends SlotsPlayerGameDataRoomDTO {
    // 缓存免费的结果库
    ...
    public PanJinLianResultLib getFreeLib() {
        return freeLib;
    }

    public void setFreeLib(PanJinLianResultLib freeLib) {
    ...
    public <T extends SlotsPlayerGameData> T converToGameData(Class<T> cla) throws Exception {
        ...
        if (t instanceof PanJinLianPlayerGameData playerGameData) {
