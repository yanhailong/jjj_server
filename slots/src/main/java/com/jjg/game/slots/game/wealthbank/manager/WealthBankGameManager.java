 ...
 */
@Component
public class WealthBankGameManager extends AbstractSlotsGameManager<WealthBankPlayerGameData, WealthBankResultLib> {

    @Autowired
    private WealthBankResultLibDao libDao;
    @Autowired
...
//        //计算火车奖励
     ...
     * @return
     */
    private WealthBankGameRunInfo allBoardTrain(WealthBankGameRunInfo gameRunInfo, WealthBankPlayerGameData playerGameData) {
     ...
     * @return
     */
    private WealthBankGameRunInfo allBoardGoldTrain(WealthBankGameRunInfo gameRunInfo, WealthBankPlayerGameData playerGameData) {
     ...
     * @return
     */
    private WealthBankGameRunInfo allBoardFree(WealthBankGameRunInfo gameRunInfo, WealthBankPlayerGameData playerGameData) {
     ...
     * @return
     */
    private WealthBankGameRunInfo areaAllUnlockGoldTrain(WealthBankGameRunInfo gameRunInfo, WealthBankPlayerGameData playerGameData) {
...
//            wealthBankResultLineInfo.times = lineInfo.getBaseTimes();
     ...
     * @param playerGameData
     */
    private WealthBankGameRunInfo checkInvers(WealthBankPlayerGameData playerGameData, WealthBankGameRunInfo gameRunInfo) {
