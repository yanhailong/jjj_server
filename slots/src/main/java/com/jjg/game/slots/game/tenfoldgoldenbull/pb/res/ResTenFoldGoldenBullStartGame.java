 ...
 * @date 2025/8/1 17:50
 */
@ProtobufMessage(messageType = MessageConst.MessageTypeDef.PEGASUS_UNBRIDLE, cmd = TenFoldGoldenBullConstant.MsgBean.RES_TEN_FOLD_GOLDEN_BULL_START_GAME,resp = true)
@ProtoDesc("开始游戏结果返回")
public class ResTenFoldGoldenBullStartGame extends AbstractResponse {
    @ProtoDesc("图标id列表")
