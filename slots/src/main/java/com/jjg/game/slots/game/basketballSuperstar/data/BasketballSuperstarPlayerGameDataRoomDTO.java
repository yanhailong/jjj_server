...
public class BasketballSuperstarPlayerGameDataRoomDTO extends SlotsPlayerGameDataRoomDTO {
    ...
    public BasketballSuperstarResultLib getFreeLib() {
        return freeLib;
    }

    public void setFreeLib(BasketballSuperstarResultLib freeLib) {
    ...
    public <T extends SlotsPlayerGameData> T converToGameData(Class<T> cla) throws Exception {
        ...
        if (t instanceof BasketballSuperstarPlayerGameData playerGameData) {
