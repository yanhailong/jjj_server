 ...
 */
@ProtobufMessage(messageType = MessageConst.MessageTypeDef.CHRISTMAS_NIGHT_TYPE, cmd = ChristmasBashNightConstant.MsgBean.RES_START_GAME,resp = true)
@ProtoDesc("开始游戏结果返回")
public class ResChristmasBashNightStartGame extends AbstractResponse {
    @ProtoDesc("图标id列表")
    ...
    public List<ChristmasBashNightCascade> addIconInfoList;


    public ResChristmasBashNightStartGame(int code) {
        super(code);
    }
}
