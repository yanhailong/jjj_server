...
public class GoldSnakeFortunePlayerGameDataRoomDTO extends SlotsPlayerGameDataRoomDTO {
    ...
    public GoldSnakeFortuneResultLib getFreeLib() {
        return freeLib;
    }

    public void setFreeLib(GoldSnakeFortuneResultLib freeLib) {
    ...
    public <T extends SlotsPlayerGameData> T converToGameData(Class<T> cla) throws Exception {
        ...
        if (t instanceof GoldSnakeFortunePlayerGameData playerGameData) {
