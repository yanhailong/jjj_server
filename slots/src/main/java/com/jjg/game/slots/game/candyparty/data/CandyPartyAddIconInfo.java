 ...
 * @date 2025/9/8 16:26
 */
public class CandyPartyAddIconInfo {
    //添加的图案， 坐标 -> 图标id
    private Map<Integer, Integer> addIconMap;
    //奖励
    private List<CandyPartyAwardLineInfo> awardLineInfoList;
    ...
    public List<CandyPartyAwardLineInfo> getAwardLineInfoList() {
        return awardLineInfoList;
    }

    public void setAwardLineInfoList(List<CandyPartyAwardLineInfo> awardLineInfoList) {
