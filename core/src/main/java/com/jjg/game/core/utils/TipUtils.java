...
public class TipUtils {
    ...
    public static void sendTip(long playerId, int tipType, Supplier<NoticeTip> supplier) {
        NoticeTip noticeTip = supplier.get();
        noticeTip.setTipType(tipType);
        getClusterSystem().sendToPlayer(noticeTip, playerId);
    }
    ...
    public static void sendTip(PlayerController playerController, int tipType, Supplier<NoticeTip> supplier) {
        if (playerController != null) {
            NoticeTip noticeTip = supplier.get();
            noticeTip.setTipType(tipType);
            playerController.send(noticeTip);
        }
    }
    ...
    public static void sendTip(PlayerController playerController, int tipType, long languageId) {
        if (playerController != null) {
            NoticeTip notice = NoticeTipBuilder.builder().tipType(tipType).languageId(languageId).build();
     ...
     * @param languageId 多语言ID
     */
    public static void sendTip(long playerId, long languageId) {
     ...
     * @param languageId 多语言ID
     */
    public static void sendTip(long playerId, int tipType, long languageId, Map<Integer, String> param) {
        ...
        sendTip(playerId, tipType, builder::build);
    }
