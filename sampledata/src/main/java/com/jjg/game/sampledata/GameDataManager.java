...
public class GameDataManager {
  ...
  public Map<Class<? extends BaseCfgBean>, BaseCfgContainer<?>> initAllContainer() {
    ...
    containerMap.put(DropItemCfg.class, new DropItemCfgContainer());
    ...
    containerMap.put(GiftListCfg.class, new GiftListCfgContainer());
    ...
    containerMap.put(MedalBuffCfg.class, new MedalBuffCfgContainer());
    ...
    containerMap.put(PopularityRankingCfg.class, new PopularityRankingCfgContainer());
    containerMap.put(PrivilegeCardCfg.class, new PrivilegeCardCfgContainer());
    containerMap.put(PropCfg.class, new PropCfgContainer());
    containerMap.put(ResearchInstituteCfg.class, new ResearchInstituteCfgContainer());
    containerMap.put(ResearchSkillsCfg.class, new ResearchSkillsCfgContainer());
  ...
  public static AirstrikeRobotCfg getAirstrikeRobotCfg(int key) {
    return getInstance().getCfgContainer(AirstrikeRobotCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, AirstrikeRobotCfg> getAirstrikeRobotCfgMap() {
    return getInstance().getCfgContainer(AirstrikeRobotCfg.class).getCfgBeanMap();
  }

  public static List<AirstrikeRobotCfg> getAirstrikeRobotCfgList() {
    return getInstance().getCfgContainer(AirstrikeRobotCfg.class).getCfgBeanList();
  }
  ...
  public static BuffCfg getBuffCfg(int key) {
    return getInstance().getCfgContainer(BuffCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, BuffCfg> getBuffCfgMap() {
    return getInstance().getCfgContainer(BuffCfg.class).getCfgBeanMap();
  }

  public static List<BuffCfg> getBuffCfgList() {
    return getInstance().getCfgContainer(BuffCfg.class).getCfgBeanList();
  }
  ...
  public static CasinoStatsSheetCfg getCasinoStatsSheetCfg(int key) {
    return getInstance().getCfgContainer(CasinoStatsSheetCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, CasinoStatsSheetCfg> getCasinoStatsSheetCfgMap() {
    return getInstance().getCfgContainer(CasinoStatsSheetCfg.class).getCfgBeanMap();
  }

  public static List<CasinoStatsSheetCfg> getCasinoStatsSheetCfgList() {
    return getInstance().getCfgContainer(CasinoStatsSheetCfg.class).getCfgBeanList();
  }
  ...
  public static DropItemCfg getDropItemCfg(int key) {
    return getInstance().getCfgContainer(DropItemCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, DropItemCfg> getDropItemCfgMap() {
    return getInstance().getCfgContainer(DropItemCfg.class).getCfgBeanMap();
  }

  public static List<DropItemCfg> getDropItemCfgList() {
    return getInstance().getCfgContainer(DropItemCfg.class).getCfgBeanList();
  }

  public static DropNumCfg getDropNumCfg(int key) {
    return getInstance().getCfgContainer(DropNumCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, DropNumCfg> getDropNumCfgMap() {
    return getInstance().getCfgContainer(DropNumCfg.class).getCfgBeanMap();
  }

  public static List<DropNumCfg> getDropNumCfgList() {
    return getInstance().getCfgContainer(DropNumCfg.class).getCfgBeanList();
  }

  public static DropTypeCfg getDropTypeCfg(int key) {
    return getInstance().getCfgContainer(DropTypeCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, DropTypeCfg> getDropTypeCfgMap() {
    return getInstance().getCfgContainer(DropTypeCfg.class).getCfgBeanMap();
  }

  public static List<DropTypeCfg> getDropTypeCfgList() {
    return getInstance().getCfgContainer(DropTypeCfg.class).getCfgBeanList();
  }
  ...
  public static EmployeeSkillConfigCfg getEmployeeSkillConfigCfg(int key) {
    return getInstance().getCfgContainer(EmployeeSkillConfigCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, EmployeeSkillConfigCfg> getEmployeeSkillConfigCfgMap() {
    return getInstance().getCfgContainer(EmployeeSkillConfigCfg.class).getCfgBeanMap();
  }

  public static List<EmployeeSkillConfigCfg> getEmployeeSkillConfigCfgList() {
    return getInstance().getCfgContainer(EmployeeSkillConfigCfg.class).getCfgBeanList();
  }
  ...
  public static GiftListCfg getGiftListCfg(int key) {
    return getInstance().getCfgContainer(GiftListCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, GiftListCfg> getGiftListCfgMap() {
    return getInstance().getCfgContainer(GiftListCfg.class).getCfgBeanMap();
  }

  public static List<GiftListCfg> getGiftListCfgList() {
    return getInstance().getCfgContainer(GiftListCfg.class).getCfgBeanList();
  }
  ...
  public static GuideDetailsCfg getGuideDetailsCfg(int key) {
    return getInstance().getCfgContainer(GuideDetailsCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, GuideDetailsCfg> getGuideDetailsCfgMap() {
    return getInstance().getCfgContainer(GuideDetailsCfg.class).getCfgBeanMap();
  }

  public static List<GuideDetailsCfg> getGuideDetailsCfgList() {
  ...
  public static MedalBuffCfg getMedalBuffCfg(int key) {
    return getInstance().getCfgContainer(MedalBuffCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, MedalBuffCfg> getMedalBuffCfgMap() {
    return getInstance().getCfgContainer(MedalBuffCfg.class).getCfgBeanMap();
  }

  public static List<MedalBuffCfg> getMedalBuffCfgList() {
    return getInstance().getCfgContainer(MedalBuffCfg.class).getCfgBeanList();
  }
  ...
  public static PopularityRankingCfg getPopularityRankingCfg(int key) {
    return getInstance().getCfgContainer(PopularityRankingCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, PopularityRankingCfg> getPopularityRankingCfgMap() {
    return getInstance().getCfgContainer(PopularityRankingCfg.class).getCfgBeanMap();
  }

  public static List<PopularityRankingCfg> getPopularityRankingCfgList() {
    return getInstance().getCfgContainer(PopularityRankingCfg.class).getCfgBeanList();
  }
  ...
  public static ResearchInstituteCfg getResearchInstituteCfg(int key) {
    return getInstance().getCfgContainer(ResearchInstituteCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, ResearchInstituteCfg> getResearchInstituteCfgMap() {
    return getInstance().getCfgContainer(ResearchInstituteCfg.class).getCfgBeanMap();
  }

  public static List<ResearchInstituteCfg> getResearchInstituteCfgList() {
    return getInstance().getCfgContainer(ResearchInstituteCfg.class).getCfgBeanList();
  }

  public static ResearchSkillsCfg getResearchSkillsCfg(int key) {
    return getInstance().getCfgContainer(ResearchSkillsCfg.class).getCfgBeanMap().get(key);
  }

  public static Map<Integer, ResearchSkillsCfg> getResearchSkillsCfgMap() {
    return getInstance().getCfgContainer(ResearchSkillsCfg.class).getCfgBeanMap();
  }

  public static List<ResearchSkillsCfg> getResearchSkillsCfgList() {
    return getInstance().getCfgContainer(ResearchSkillsCfg.class).getCfgBeanList();
  }
