...
public class MiningRankingCfg extends BaseCfgBean {

  /** 配置表名 */
  public static final String EXCEL_NAME = "MiningRanking.xlsx";
  /** 配置表工作薄名 */
  public static final String SHEET_NAME = "MiningRanking";
