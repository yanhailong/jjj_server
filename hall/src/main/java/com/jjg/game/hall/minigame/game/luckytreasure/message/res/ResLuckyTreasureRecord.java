...
@ProtobufMessage(
        ...
        cmd = LuckyTreasureConstant.Message.RES_LUCKY_TREASURE_RECORD,
        resp = true
)
@ProtoDesc("请求查看夺宝奇兵记录回复")
public class ResLuckyTreasureRecord extends AbstractResponse {
    ...
    public ResLuckyTreasureRecord(int code) {
        super(code);
    }
