 ...
 * 通知更新夺宝奇兵库存
 */
@ProtobufMessage(messageType = MessageConst.MessageTypeDef.HALL_TYPE, cmd = LuckyTreasureConstant.Message.NOTIFY_LUCKY_TREASURE_UPDATE, resp = true)
@ProtoDesc("通知更新夺宝奇兵库存")
public class NotifyLuckyTreasureUpdate extends AbstractNotice {
